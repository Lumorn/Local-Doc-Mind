...
Beim Laden des OCR-Modells wird zudem geprueft, ob `addict` installiert ist, damit fehlende Pakete sofort mit einem klaren Hinweis (inklusive Verweis auf `requirements.txt`) gemeldet werden.
